...
WORKDIR /go/src/github.com/rexmont/flagr
ADD . .
...
COPY --from=builder /go/src/github.com/rexmont/flagr/flagr ./flagr
COPY --from=builder /go/src/github.com/rexmont/flagr/browser/flagr-ui/dist ./browser/flagr-ui/dist
COPY --from=builder /go/src/github.com/rexmont/flagr/buildscripts ./buildscripts
