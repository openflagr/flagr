...
func (m EvaluationBatchRequestEntities) Validate(formats strfmt.Registry) error {
	var res []error

	iEvaluationBatchRequestEntitiesSize := int64(len(m))

	if err := validate.MinItems("", "body", iEvaluationBatchRequestEntitiesSize, 1); err != nil {
		return err
	}
