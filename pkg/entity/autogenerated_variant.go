...
// nolint: dupl
func (qs VariantQuerySet) FlagIDIn(flagID ...uint) VariantQuerySet {
	if len(flagID) == 0 {
...
// nolint: dupl
func (qs VariantQuerySet) FlagIDNotIn(flagID ...uint) VariantQuerySet {
	if len(flagID) == 0 {
...
// nolint: dupl
func (qs VariantQuerySet) IDIn(ID ...uint) VariantQuerySet {
	if len(ID) == 0 {
...
// nolint: dupl
func (qs VariantQuerySet) IDNotIn(ID ...uint) VariantQuerySet {
	if len(ID) == 0 {
...
// nolint: dupl
func (qs VariantQuerySet) KeyIn(key ...string) VariantQuerySet {
	if len(key) == 0 {
...
// nolint: dupl
func (qs VariantQuerySet) KeyNotIn(key ...string) VariantQuerySet {
	if len(key) == 0 {
...
// nolint: dupl
func (qs VariantQuerySet) Offset(offset int) VariantQuerySet {
...
// VariantDBSchemaField describes database schema field. It requires for method 'Update'
