...
// nolint: dupl
func (qs FlagQuerySet) NameEq(name string) FlagQuerySet {
	return qs.w(qs.db.Where("name = ?", name))
}

// NameIn is an autogenerated method
// nolint: dupl
func (qs FlagQuerySet) NameIn(name ...string) FlagQuerySet {
	if len(name) == 0 {
...
// nolint: dupl
func (qs FlagQuerySet) NameNe(name string) FlagQuerySet {
	return qs.w(qs.db.Where("name != ?", name))
}

// NameNotIn is an autogenerated method
// nolint: dupl
func (qs FlagQuerySet) NameNotIn(name ...string) FlagQuerySet {
	if len(name) == 0 {
...
// nolint: dupl
func (u FlagUpdater) SetName(name string) FlagUpdater {
	u.fields[string(FlagDBSchema.Name)] = name
	return u
}
