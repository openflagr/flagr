...
// nolint: dupl
func (qs FlagQuerySet) LabelEq(label string) FlagQuerySet {
	return qs.w(qs.db.Where("label = ?", label))
}

// LabelIn is an autogenerated method
// nolint: dupl
func (qs FlagQuerySet) LabelIn(label ...string) FlagQuerySet {
	if len(label) == 0 {
...
// nolint: dupl
func (qs FlagQuerySet) LabelNe(label string) FlagQuerySet {
	return qs.w(qs.db.Where("label != ?", label))
}

// LabelNotIn is an autogenerated method
// nolint: dupl
func (qs FlagQuerySet) LabelNotIn(label ...string) FlagQuerySet {
	if len(label) == 0 {
...
// nolint: dupl
func (u FlagUpdater) SetLabel(label string) FlagUpdater {
	u.fields[string(FlagDBSchema.Label)] = label
	return u
}
