...
// PreloadSegmentEvaluation is an autogenerated method
// nolint: dupl
func (qs SegmentQuerySet) PreloadSegmentEvaluation() SegmentQuerySet {
	return qs.w(qs.db.Preload("SegmentEvaluation"))
}
...
// SetSegmentEvaluation is an autogenerated method
// nolint: dupl
func (u SegmentUpdater) SetSegmentEvaluation(segmentEvaluation SegmentEvaluation) SegmentUpdater {
	u.fields[string(SegmentDBSchema.SegmentEvaluation)] = segmentEvaluation
	return u
}
...
var SegmentDBSchema = struct {
	...
	SegmentEvaluation segmentDBSchemaField
}{
	...
	SegmentEvaluation: segmentDBSchemaField("segment_evaluation"),
}
...
func (o *Segment) Update(db *gorm.DB, fields ...segmentDBSchemaField) error {
	dbNameToFieldName := map[string]interface{}{
		...
		"segment_evaluation": o.SegmentEvaluation,
	}
