...
// nolint: dupl
func (qs SegmentQuerySet) DescriptionIn(description ...string) SegmentQuerySet {
...
// nolint: dupl
func (qs SegmentQuerySet) DescriptionNotIn(description ...string) SegmentQuerySet {
	if len(description) == 0 {
...
// nolint: dupl
func (qs SegmentQuerySet) FlagIDIn(flagID ...uint) SegmentQuerySet {
	if len(flagID) == 0 {
...
// nolint: dupl
func (qs SegmentQuerySet) FlagIDNotIn(flagID ...uint) SegmentQuerySet {
	if len(flagID) == 0 {
...
// nolint: dupl
func (qs SegmentQuerySet) IDIn(ID ...uint) SegmentQuerySet {
	if len(ID) == 0 {
...
// nolint: dupl
func (qs SegmentQuerySet) IDNotIn(ID ...uint) SegmentQuerySet {
	if len(ID) == 0 {
...
// nolint: dupl
func (qs SegmentQuerySet) Offset(offset int) SegmentQuerySet {
...
// nolint: dupl
func (qs SegmentQuerySet) RankIn(rank ...uint) SegmentQuerySet {
	if len(rank) == 0 {
		qs.db.AddError(errors.New("must at least pass one rank in RankIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("rank IN (?)", rank))
}
...
// nolint: dupl
func (qs SegmentQuerySet) RankNotIn(rank ...uint) SegmentQuerySet {
	if len(rank) == 0 {
		qs.db.AddError(errors.New("must at least pass one rank in RankNotIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("rank NOT IN (?)", rank))
}
...
// nolint: dupl
func (qs SegmentQuerySet) RolloutPercentIn(rolloutPercent ...uint) SegmentQuerySet {
	if len(rolloutPercent) == 0 {
		qs.db.AddError(errors.New("must at least pass one rolloutPercent in RolloutPercentIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("rollout_percent IN (?)", rolloutPercent))
}
...
// nolint: dupl
func (qs SegmentQuerySet) RolloutPercentNotIn(rolloutPercent ...uint) SegmentQuerySet {
	if len(rolloutPercent) == 0 {
		qs.db.AddError(errors.New("must at least pass one rolloutPercent in RolloutPercentNotIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("rollout_percent NOT IN (?)", rolloutPercent))
}
...
// SegmentDBSchemaField describes database schema field. It requires for method 'Update'
