...
/** entityContext property prefix for Jev answers: question `foo` → `@jev_foo`. */
export const JEV_PROPERTY_PREFIX = '@jev_'
...
/** Strip the `@jev_` prefix from a constraint property. */
...
/** Build the `@jev_<slug>` property for a question name. */
